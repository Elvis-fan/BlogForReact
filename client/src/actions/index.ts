import { ARTICLES_TYPE, CLASSES_TYPE, TOP_ARTICLES_TYPE, POST_ARTICLES_TYPE, ARTICLE_TYPE, SIGN_IN_TYPE } from 'src/action-types'
import { createAction } from 'redux-actions'
import { Article as ArticleModel, User as UserModel } from 'src/models'
